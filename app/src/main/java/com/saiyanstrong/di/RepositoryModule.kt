...
import com.saiyanstrong.data.repository.BiomechanicsRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    abstract fun bindBiomechanicsRepository(impl: BiomechanicsRepositoryImpl): BiomechanicsRepository
}
