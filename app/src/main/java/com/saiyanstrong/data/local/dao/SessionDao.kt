...
interface SessionDao {
    ...
    @Query("UPDATE sessions SET total_volume_kg = :totalVolumeKg, power_earned = :powerEarned WHERE id = :id")
    suspend fun updateTotals(id: Long, totalVolumeKg: Double, powerEarned: Int)
