        ...
        Box(
            ...
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                LazyRow(
                    ...
                    item {
                        SaiyanFilterChip(!sortByUsage, "A-Z") { sortByUsage = false }
                    }
                    item {
                        SaiyanFilterChip(sortByUsage, "RECENT") { sortByUsage = true }
                    }
                    item {
                        SaiyanFilterChip(selectedCategory == null, "ALL") { selectedCategory = null }
                    }
...
@Composable
private fun SaiyanFilterChip(selected: Boolean, label: String, onClick: () -> Unit) {
    FilterChip(
        selected = selected,
        onClick = onClick,
